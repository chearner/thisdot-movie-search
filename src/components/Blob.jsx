export default function Blob(props) {
  return (
    <div style={{ filter: 'blur(100px)', pointerEvents: 'none', position: 'fixed', minWidth: '100%', marginTop: '0', height: '180%', top: '50%', left: '50%', transform: 'translateX(-50%) translateY(-50%)', zIndex: '0', opacity: props.opacity }}>
